...
class ObjetivoSerializer(serializers.ModelSerializer):
    meta = serializers.DecimalField(max_digits=20, decimal_places=2, coerce_to_string=False)
    actual = serializers.DecimalField(max_digits=20, decimal_places=2, coerce_to_string=False)
    class Meta:
